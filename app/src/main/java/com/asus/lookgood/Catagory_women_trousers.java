...
public class Catagory_women_trousers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catagory_women_trousers);
    ...
    private void GetDataFromFirebase() {
        Query query = myref.child("Womentrousers");
