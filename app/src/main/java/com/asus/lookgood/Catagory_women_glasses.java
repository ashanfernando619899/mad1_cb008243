...
public class Catagory_women_glasses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catagory_women_glasses);
    ...
    private void GetDataFromFirebase() {
        Query query = myref.child("Womenglasses");
