...
public class Catagory_women_tshirts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catagory_women_tshirts);
    ...
    private void GetDataFromFirebase() {
        Query query = myref.child("Womentshirts");
