...
public class Catagory_kids_trousers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catagory_kids_trousers);
    ...
    private void GetDataFromFirebase() {
        Query query = myref.child("kidstrousers");
